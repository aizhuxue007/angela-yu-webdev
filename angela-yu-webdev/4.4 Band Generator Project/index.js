...
app.post("/submit", (req, res) => {
  ...
  const adjPick = capitalize(adj[Math.floor(Math.random() * adj.length)]);
  const nounPick = capitalize(noun[Math.floor(Math.random() * noun.length)]);
  const data = {
    year: year,
    adjective: adjPick,
    noun: nounPick
  }
  console.log(adjPick + nounPick);
  res.render('index.ejs', data)
});
